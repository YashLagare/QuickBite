...
// //                                 className={`w-full px-4 py-3 bg-white/70 border rounded-xl focus:outline-none focus:ring-2 transition-all duration-200 ${errors.name
...
// //                             {!frontendImage ? (
// //                                 <label className={`flex flex-col items-center justify-center w-full h-48 border-2 border-dashed rounded-xl cursor-pointer bg-white/50 hover:bg-white/70 transition-all duration-200 group ${errors.image ? 'border-red-400' : 'border-gray-300'
// //                                     }`}>
// //                                     <div className='flex flex-col items-center justify-center pt-5 pb-6'>
// //                                         <svg
// //                                             className={`w-10 h-10 mb-3 transition-colors ${errors.image ? 'text-red-400' : 'text-gray-400 group-hover:text-orange-500'
// //                                                 }`}
// //                                             fill="none"
// //                                             stroke="currentColor"
// //                                             viewBox="0 0 24 24"
...
// //                                     type="number"
// //                                     placeholder='0'
// //                                     className={`w-full pl-8 pr-4 py-3 bg-white/70 border rounded-xl focus:outline-none focus:ring-2 transition-all duration-200 ${errors.price
// //                                         ? 'border-red-400 focus:ring-red-400'
// //                                         : 'border-gray-200 focus:ring-orange-400/50 focus:border-transparent'
// //                                         }`}
...
// //                             </label>
// //                             <select
// //                                 className={`w-full px-4 py-3 bg-white/70 border rounded-xl focus:outline-none focus:ring-2 transition-all duration-200 appearance-none cursor-pointer ${errors.category
// //                                     ? 'border-red-400 focus:ring-red-400'
// //                                     : 'border-gray-200 focus:ring-orange-400/50 focus:border-transparent'
// //                                     }`}
...
// //                             </label>
// //                             <select
// //                                 className='w-full px-4 py-3 bg-white/70 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-400/50 focus:border-transparent transition-all duration-200 appearance-none cursor-pointer'
